...
class CPSEMultiAgentSystem:
    ...
    def process_request(self, user_input, context="", ui_state="", image_path=None):
        ...
        sih_context = "[BACKGROUND KNOWLEDGE: SIH stands for Smart India Hackathon 2026, a national competition. 'SyncMasters' is the team name and the name of the software platform built for the Ministry of Petroleum & Natural Gas. SIH is NOT the name of the platform, it is the event.]\n"
